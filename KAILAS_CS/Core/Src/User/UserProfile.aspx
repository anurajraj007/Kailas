<%@ Page Title="" Language="C#" MasterPageFile="~/Core/Masters/User.Master" AutoEventWireup="true" CodeBehind="UserProfile.aspx.cs" Inherits="KAILAS_CS.Core.Src.User.UserProfile" %>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-pencil"></i></span>
                                    <asp:TextBox runat="Server" ID="txt_Pin" placeholder="Pin" class="form-control"></asp:TextBox>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group input-group">
                                    ...
                                    <asp:TextBox runat="Server" ID="txt_Email" placeholder="Email" class="form-control" disabled="true"></asp:TextBox>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-pencil"></i></span>
                                    <asp:TextBox runat="Server" ID="txt_Phone" placeholder="Phone" class="form-control"></asp:TextBox>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group input-group">
                                    ...
                                    <asp:TextBox runat="Server" ID="txt_Mobile" placeholder="Mobile" class="form-control" Required></asp:TextBox>
                                </div>
                            </div>
                              <div class="form-group">
