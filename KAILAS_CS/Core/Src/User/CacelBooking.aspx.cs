...
{
    public partial class CacelBooking : System.Web.UI.Page
    {
        ...
        public void BindDatas(DataSet Dt)
        {
            ...
            //ddl_Status.SelectedValue = Convert.ToString(Dt.Tables[0].Rows[0]["BookingStatus"]);
        ...
        protected void btn_Ok_Click(object sender, EventArgs e)
        {
            ...
            Int64 i = USER.UpdateUserBookingStatus(dtBookingDetailsUpdate);
