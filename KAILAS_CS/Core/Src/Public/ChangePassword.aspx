<%@ Page Title="" Language="C#" MasterPageFile="~/Core/Masters/Public.Master" AutoEventWireup="true" CodeBehind="ChangePassword.aspx.cs" Inherits="KAILAS_CS.Core.Src.Public.ChangePassword" %>
                        ...
                        <form role="form">
                            <fieldset>
                                ...
                                <div class="form-group input-group">
                                    ...
                                    <asp:TextBox runat="Server" ID="txt_OldPassword" placeholder="password" 
                                ...
                                <div class="form-group input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-envelope"></i></span>
                                    <asp:TextBox runat="Server" ID="txt_NewPassword" placeholder="password" 
                                        class="form-control" TextMode="Password"></asp:TextBox>
                                </div>
                            </div>
