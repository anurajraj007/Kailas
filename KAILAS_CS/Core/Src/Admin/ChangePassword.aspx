<%@ Page Title="" Language="C#" MasterPageFile="~/Core/Masters/Admin.Master" AutoEventWireup="true" CodeBehind="ChangePassword.aspx.cs" Inherits="KAILAS_CS.Core.Src.Admin.ChangePassword" %>
        ...
        <div class="row">
            ...
            <div class="form-group input-group">
                <asp:Button runat="server" ID="btn_Submit" Text="OK" class="btn btn-lg btn-success"
                    ...
                    style="margin-left: 42px; margin-top: 15px" Text="CANCEL" Height="25px" 
