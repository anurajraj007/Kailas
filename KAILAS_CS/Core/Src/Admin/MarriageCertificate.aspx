<%@ Page Title="" Language="C#" MasterPageFile="~/Core/Masters/Admin.Master" AutoEventWireup="true" CodeBehind="MarriageCertificate.aspx.cs" Inherits="KAILAS_CS.Core.Src.Admin.MarriageCertificate1" %>
                              ...
                              <div class="col-lg-6">
                                 <div class="panel-body">
                                    <div class="form-group">
                                       ...
                                       <div class="form-group input-group">
                                          <span class="input-group-addon"><i class="glyphicon glyphicon-pencil"></i></span>
                                          <asp:TextBox runat="Server" ID="txt_time" placeholder="Time" Text='0.0' class="form-control" Required></asp:TextBox>
                                       </div>
                                    </div>
                                    <div class="form-group">
                               ...
                               <div class="form-group">
                                 ...
                                 <div class="form-group input-group">
                                    ...
                                    <asp:TextBox runat="Server" ID="txt_BGPin" placeholder="Pin" 
                                         class="form-control" MaxLength="6" MinLength="6" TextMode="Number" Required></asp:TextBox>
                                 </div>
                              </div>
                               <div class="form-group">
                                 <label>Mobile</label>
                                 <div class="form-group input-group">
                                    ...
                                    <asp:TextBox runat="Server" ID="txt_BGMobile" placeholder="Mobile" 
                                         class="form-control"  TextMode="Phone" Required></asp:TextBox>
                                 </div>
                              </div>
                               <div class="form-group">
                                 <label>Email</label>
                                 <div class="form-group input-group">
                                    ...
                                    <asp:TextBox runat="Server" ID="txt_Email" placeholder="Email" 
                                         class="form-control" Required TextMode="Email"></asp:TextBox>
                                 </div>
                              </div>
                              <div class="form-group">
                           ...
                           <div class="panel-body">
                              ...
                              <div class="form-group">
                               ...
                               <div class="form-group">
                                 ...
                                 <div class="form-group input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-pencil"></i></span>
                                    <asp:TextBox runat="Server" ID="txt_BPin" placeholder="Pin" class="form-control" MaxLength="6" MinLength="6"
                                         TextMode="Number" ></asp:TextBox>
                                 </div>
                              </div>
                               <div class="form-group">
                                 ...
                                 <div class="form-group input-group">
                                    ...
                                    <asp:TextBox runat="Server" ID="txt_BMobile" placeholder="Mobile" 
                                         class="form-control" MaxLength="10" MinLength="10" TextMode="Phone"></asp:TextBox>
                                 </div>
                              </div>
                               <div class="form-group">
                                 <label>Email</label>
