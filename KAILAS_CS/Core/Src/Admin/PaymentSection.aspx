<%@ Page Title="" Language="C#" MasterPageFile="~/Core/Masters/Admin.Master" AutoEventWireup="true" CodeBehind="PaymentSection.aspx.cs" Inherits="KAILAS_CS.Core.Src.Admin.PaymentSection" %>
                        ...
                        <div class="panel-body">
                           ...
                           <div class="col-lg-6">
                               <div class="form-group">
                                 ...
                                 <div class="form-group input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-pencil"></i></span>
                                    <asp:TextBox runat="Server" ID="txt_EventDate2" placeholder="Event Date" class="form-control" ></asp:TextBox>
                                 </div>
                              </div>
                                <div class="form-group">
                                 ...
                                 <div class="form-group input-group">
                                    ...
                                    <asp:TextBox runat="Server" ID="txt_HallRent" 
                                         ...
                                         ontextchanged="txt_HallRent_TextChanged" AutoPostBack="true"></asp:TextBox>
                                 </div>
                              </div>
                               ...
                               <div class="form-group">
                                 ...
                                 <div class="form-group input-group">
                                    ...
                                    <asp:TextBox runat="Server" ID="txt_Food" placeholder="Food charge" 
                                         class="form-control" ontextchanged="txt_Food_TextChanged"  AutoPostBack="true"></asp:TextBox>
                                 </div>
                              </div>
                               <div class="form-group">
                                 ...
                                 <div class="form-group input-group">
                                    ...
                                    <asp:TextBox runat="Server" ID="txt_Cleaning" placeholder="Cleaning" 
                                         class="form-control" ontextchanged="txt_Cleaning_TextChanged" AutoPostBack="true"></asp:TextBox>
                                 </div>
                              </div>
                               <div class="form-group">
                                 ...
                                 <div class="form-group input-group">
                                    ...
                                    <asp:TextBox runat="Server" ID="txt_Water" placeholder="WaterBill" 
                                         class="form-control" ontextchanged="txt_Water_TextChanged"  AutoPostBack="true"></asp:TextBox>
                                 </div>
                              </div>
                               <div class="form-group">
                                 <label>Tax</label>
                                 <div class="form-group input-group">
                                    ...
                                    <asp:TextBox runat="Server" ID="txt_Tax" placeholder="Tax" class="form-control" 
                                         ontextchanged="txt_Tax_TextChanged"  AutoPostBack="true"></asp:TextBox>
                                 </div>
                              </div>
                              </div>
                            <div class="col-lg-6">
                               ...
                               <div class="form-group">
                                 ...
                                 <div class="form-group input-group">
                                    ...
                                    <asp:TextBox runat="Server" ID="txt_Catering" 
                                         ...
                                         ontextchanged="txt_Catering_TextChanged"></asp:TextBox>
                                 </div>
                              </div>
                               <div class="form-group">
                                 ...
                                 <div class="form-group input-group">
                                    ...
                                    <asp:TextBox runat="Server" ID="txt_ExtraDecoration" 
                                         ...
                                         ontextchanged="txt_ExtraDecoration_TextChanged"  AutoPostBack="true"></asp:TextBox>
                                 </div>
                              </div>
                               <div class="form-group">
                                 ...
                                 <div class="form-group input-group">
                                    ...
                                    <asp:TextBox runat="Server" ID="txt_Service" placeholder="Service charge" 
                                         class="form-control" ontextchanged="txt_Service_TextChanged"  AutoPostBack="true"></asp:TextBox>
                                 </div>
                              </div>
                               <div class="form-group">
                                 ...
                                 <div class="form-group input-group">
                                    ...
                                    <asp:TextBox runat="Server" ID="txt_Electricity" placeholder="Electricity Bill" 
                                         class="form-control" ontextchanged="txt_Electricity_TextChanged"  AutoPostBack="true"></asp:TextBox>
                                 </div>
                              </div>
                               <div class="form-group">
                                 <label>Others</label>
                                 <div class="form-group input-group">
                                    ...
                                    <asp:TextBox runat="Server" ID="txt_Others" placeholder="Others" 
                                         class="form-control" ontextchanged="txt_Others_TextChanged"  AutoPostBack="true"></asp:TextBox>
                                 </div>
                              </div>
                              </div>
                               ...
                               <div class="form-group">
                                 ...
                                 <div class="form-group input-group">
                                    ...
                                    <asp:TextBox runat="Server" ID="txt_Advance" placeholder="Advance" 
                                         class="form-control" ontextchanged="txt_Advance_TextChanged"  AutoPostBack="true"></asp:TextBox>
                                 </div>
                              </div>
                              </div>
                               <div class="col-lg-4">
